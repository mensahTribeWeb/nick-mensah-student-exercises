-- 21. The census region, and the average, minimum, and maximum population
--of states and districts in each census region. Exclude ones that don't have a census region.
